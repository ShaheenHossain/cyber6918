...
class EducationHostelMember(models.Model):
    ...
    state_id = fields.Many2one(string='State', related='member_std_name.per_state_id')
    country_id = fields.Many2one(string='Country', related='member_std_name.per_country_id')
