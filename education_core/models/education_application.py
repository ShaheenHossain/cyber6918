...
class StudentApplication(models.Model):
    ...
    name_b = fields.Char("Name in Bangla")
    ...
    register_id = fields.Many2one('education.admission.register', string="Admission Register", 
    ...
    #### Father Details
    father_name = fields.Char(string="Father's Name Egnlish ", help="Proud to say my father is",required=True)
    father_name_b = fields.Char(string="Father's Name in Bangla ", help="Proud to say my father is")
    ...
    #### Mother Details
    mother_name = fields.Char(string="Mother's Name in English ", help="Proud to say my mother is",required=True)
    mother_name_b = fields.Char(string="Mother's Name in Bangla", help="Proud to say my mother is")
